        ...
        <div className="flex h-screen">
            ...
            <div className="flex flex-col w-1/2 gap-6 items-center justify-center p-10">
                ...
                <div className="flex flex-col gap-3 w-full max-w-xs">
                    <input type="text" placeholder="Username" className="bg-gray-200 p-3 rounded" />
                    <input type="text" placeholder="Password" className="bg-gray-200 p-3 rounded" />
                    <CustomButton text="LogIn" className="bg-primary-color text-text-color hover:bg-white hover:text-primary-color transition-all" />
                    <TextDivider />
